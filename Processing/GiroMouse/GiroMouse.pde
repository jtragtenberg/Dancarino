...
void draw() {
  ...
  padXY.inputParamXMin = -30;
  padXY.inputParamXMax = 30;
  padXY.inputParamYMin = 0;
  padXY.inputParamYMax = 40;
  //padXY.inputParamButtonMin = 0;
  //padXY.inputParamButtonMax = 1;
  int button = 0;
  if (board.buttonPressed) button = 1;
  
  //padXY.updateEffect(degrees(board.ypr[0] - yawOffset), degrees(board.ypr[1]),button);
  padXY.updateEffect(degrees(board.ypr[0] - yawOffset), degrees(board.ypr[1]));
  //GUI

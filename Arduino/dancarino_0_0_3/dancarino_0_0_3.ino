...
void loop()
{
  ...
  int w = int((motioner.mRazorIMU.quat.w + 1)*100);
  int x = int((motioner.mRazorIMU.quat.x + 1)*100);
  int y = int((motioner.mRazorIMU.quat.y + 1)*100);
  int z = int((motioner.mRazorIMU.quat.z + 1)*100);
